...
class UserPanelView(TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['recent_orders'] = Order.objects.filter(user=self.request.user, is_paid=True)
...
class OrdersView(UserPanelView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['user_orders'] = Order.objects.filter(user=self.request.user, is_paid=True)
        return context
